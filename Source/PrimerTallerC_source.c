...
Semanas 33
Días: 3*/
int nDias,anhos,semanas,dias,residuoAños,residuoSemanas;
printf("\n\n--------------");
printf(" Ejercicio 2 ");
printf("--------------\n\n");
...
residuoAños = (nDias%365);

printf("\nAños : %d",(nDias/365));
residuoSemanas=residuoAños%7;
printf("\nSemanas : %d",residuoAños/7);
...
int producto[tamanho][tamanho];

printf("\n* Producto de Matrices *\n\n");
for (int i=0;i<tamanho;i++){
   for (int j=0;j<tamanho;j++){
    for (int suma=0,k=0;k<tamanho;k++){
